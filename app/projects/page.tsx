  ...
  return (
    <div className='divide-y divide-gray-200 dark:divide-gray-700'>
      ...
      <div className="grid gap-y-8 sm:grid-cols-2 sm:gap-6 md:gap-6 lg:grid-cols-3 lg:gap-10 pt-8">
        {data.map(project=>(
          <article key={project._id} className="overflow-hidden dark:border-zinc-600 rounded-lg
              border border-gray-100 bg-white shadow-lg dark:bg-black dark:shadow-gray-700 shadow-gray-200">
            <div className="h-56 w-full relative" >
              <Image fill src={project.imageUrl} alt="projectImage" className="w-full h-full object-center"/>
            </div>
            <div className="p-4 sm:p-6">
              ...
              <p className="line-clamp-4 mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                  {project.overview}
              </p>
              <a href={project.link} target="_blank" 
